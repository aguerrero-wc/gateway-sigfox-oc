...
const SEED_LOCATIONS: Partial<Location>[] = [
  {
    ...
    longitude: -3.6826,
    radiusMeters: 200,
    mbs: 'Main northern distribution warehouse',
  ...
  },
  {
    ...
    longitude: -3.7024,
    radiusMeters: 350,
    mbs: 'Secondary logistics hub — cold chain certified',
    clientId: 'a1b2c3d4-0001-4000-8000-000000000001',
  },
  {
    name: 'Office HQ',
    ...
    longitude: -3.7025,
    radiusMeters: 50,
    mbs: 'Corporate headquarters — restricted access',
  ...
  },
  {
    ...
    longitude: 2.1734,
    radiusMeters: 500,
    mbs: 'Maritime container terminal — 24h operations',
    clientId: 'a1b2c3d4-0001-4000-8000-000000000002',
  },
  {
    ...
    longitude: -0.9057,
    radiusMeters: 250,
    mbs: 'Refrigerated storage — temperature monitored',
  ...
  },
  {
    ...
    longitude: -74.0817,
    radiusMeters: 300,
    mbs: 'Primary LATAM distribution node',
  ...
  },
  {
    ...
    longitude: -75.5740,
    radiusMeters: 150,
    mbs: 'Regional depot — Antioquia coverage',
    clientId: 'a1b2c3d4-0001-4000-8000-000000000004',
  },
  {
    ...
    longitude: 12.2388,
    radiusMeters: 400,
    mbs: 'Air freight intake — customs bonded zone',
  ...
  },
  {
    ...
    longitude: 9.2744,
    radiusMeters: 200,
    mbs: 'E-commerce fulfilment centre',
    clientId: 'a1b2c3d4-0001-4000-8000-000000000005',
  },
  {
    ...
    longitude: -0.3189,
    radiusMeters: 600,
    mbs: 'Mediterranean gateway — import/export checkpoint',
    clientId: 'a1b2c3d4-0001-4000-8000-000000000003',
  },
];
